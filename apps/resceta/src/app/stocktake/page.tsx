  ...
  return (
    <AppShell staff={staff}>
      <main className="mx-auto max-w-5xl px-6 py-10">
        ...
        {open ? (
          <p className="mb-8 rounded-xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-900">
              ...
              <tbody className="divide-y divide-slate-100">
                {rows.map((s) => (
                  <tr key={s.id}>
                    ...
                    <td className="px-4 py-2">
                      <span className="rounded bg-slate-100 px-2 py-0.5 text-xs">{s.status}</span>
                    </td>
                    ...
                    <td
                      className={`px-4 py-2 text-right tabular-nums ${
                        s.varianceUnits < 0 ? "text-red-700" : s.varianceUnits > 0 ? "text-amber-700" : ""
                      }`}
                    >
                      {s.varianceUnits > 0 ? "+" : ""}
                      {s.varianceUnits}
