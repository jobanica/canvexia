...
export function ApplyPartnerForm() {
  ...
  if (state?.ok) {
    return (
      <div className="rounded-tile border border-brand-ink/10 bg-white p-6 text-center">
  ...
  return (
    <form action={action} className="space-y-4 rounded-tile border border-brand-ink/10 bg-white p-6">
      ...
      <p className="rounded-lg bg-brand-surface px-3 py-2 text-xs text-brand-ink/55">
