 ...
 *
 * It lives in packages/ui rather than in one app because TWO apps now draw it —
 * canvexia.com and the partner portal, which run in different Next processes —
 * and a logo copied into both is a logo that drifts. That is the same argument
 * D36 made for provisioning, and it is why packages/ui stopped being an empty
